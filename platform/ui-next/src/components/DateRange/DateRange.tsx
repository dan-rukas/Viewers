        ...
        <Popover.PopoverTrigger asChild>
          <div className="relative w-full">
            ...
            <input
              ...
              className={cn(
                'border-inputfield-main focus:border-inputfield-focus hover:text-foreground h-[32px] w-full justify-start rounded border bg-black py-[6.5px] pl-[6.5px] pr-[6.5px] text-left text-sm font-normal hover:bg-black',
        ...
        <Popover.PopoverTrigger asChild>
          <div className="relative w-full">
            ...
            <input
              ...
              className={cn(
                'border-inputfield-main focus:border-inputfield-focus hover:text-foreground h-full w-full justify-start rounded border bg-black py-[6.5px] pl-[6.5px] pr-[6.5px] text-left text-sm font-normal hover:bg-black',
