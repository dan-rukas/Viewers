  ...
  return (
    <div className="bg-muted flex flex-col gap-2 border-b border-b-[2px] border-black px-2 py-3">
      <div className="flex items-center gap-2">
        ...
        />
        <span className="text-foreground text-sm">{t('Preview edits before creating')}</span>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <span className="text-foreground text-sm">{t('Use center as segment index')}</span>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <span className="text-foreground text-sm">{t('Hover on segment border to activate')}</span>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <span className="text-foreground text-sm">{t('Show segment name on hover')}</span>
      </div>
    </div>
  );
}
