  ...
  return (
    <>
      {viewportDisplaySets && viewportDisplaySets.length > 1 && (
        <div className="flex h-8 w-full shrink-0 items-center justify-center px-2 text-base">
          <Tabs
      ...
      <div
        className="hover:bg-accent flex h-8 w-full shrink-0 cursor-pointer items-center px-2 text-base hover:rounded"
        onClick={() => setShowPreview(!showPreview)}
      >
        <span className="shrink-0">{t('Preview in viewport')}</span>
        <Switch
